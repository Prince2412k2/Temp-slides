      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", zIndex: 1, marginTop: "4vh", gap: "3vh" }}>
        ...
        <div style={{ display: "flex", gap: "4vw" }}>
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "1.8vw", fontWeight: 600, margin: "0 0 1vh 0", color: "#1E1E1E" }}>Definition</p>
            <p style={{ fontSize: "1.8vw", lineHeight: 1.5, color: "#555555", margin: 0 }}>The application of knowledge, skills, tools, and techniques to meet project requirements and achieve the desired outcome.</p>
          </div>
          <div style={{ flex: 1 }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", backgroundColor: "#7B9FCC", marginBottom: "1.5vh" }} />
            <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "1.8vw", fontWeight: 600, margin: "0 0 1vh 0", color: "#1E1E1E" }}>Key Activities</p>
            <p style={{ fontSize: "1.8vw", lineHeight: 1.6, color: "#555555", margin: 0 }}>Planning and organizing · Managing tasks · Budgeting and controlling costs · Ensuring delivery on time and within scope</p>
          </div>
          <div style={{ flex: 1 }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", backgroundColor: "#7BC8A4", marginBottom: "1.5vh" }} />
            <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: "1.8vw", fontWeight: 600, margin: "0 0 1vh 0", color: "#1E1E1E" }}>Why It Matters</p>
            <p style={{ fontSize: "1.8vw", lineHeight: 1.5, color: "#555555", margin: 0 }}>Businesses depend on project management to deliver expected outcomes on time and within budget.</p>
          </div>
        </div>
      </div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", zIndex: 1 }}>
        <div style={{ fontSize: "1vw", color: "#888888", display: "flex", alignItems: "center", gap: "1vw" }}>
          <span>02</span><span style={{ width: "2vw", height: "1px", backgroundColor: "#888888" }} /><span>Google PM Certificate</span>
        </div>
